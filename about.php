    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="team-card bg-white rounded-lg shadow-lg overflow-hidden text-center">
                    <div class="team-portrait">
                        <img src="assets/images/team/mahesh-fernando.jpg" alt="Mahesh Fernando, Head of Operations at Serendib Pathways" loading="eager" decoding="async" style="object-position: center 8%;">
                    </div>
                    <div class="p-6">
