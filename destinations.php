...
$extra_stylesheet_secondary = 'assets/css/destinations-visibility.css?v=4';
include 'includes/header.php';
?>

<!-- Hero Section -->
<section class="destinations-hero" style="background: #173f32 url('PHOTOS/ChatGPT%20Image%20Sep%206,%202026,%2009_02_59%20AM.png') center 58% / cover no-repeat;">
